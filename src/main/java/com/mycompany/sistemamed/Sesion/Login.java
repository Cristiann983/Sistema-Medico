...
import com.mycompany.sistemamed.inicioDoc;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LogoDoc_2.png"))); // NOI18N
        bg.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 100, 290, 140));

        logoname.setBackground(new java.awt.Color(255, 255, 255));
        logoname.setFont(new java.awt.Font("Roboto Medium", 0, 18)); // NOI18N
        logoname.setForeground(new java.awt.Color(255, 255, 255));
        logoname.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logoname.setText("Clinica Luz");
...
private void abrirVentanaAdministrador() {
    inicioAdmi ventanaAdmin = new inicioAdmi();
    ventanaAdmin.setVisible(true);
    this.dispose(); // Cierra la ventana de login
}

private void abrirVentanaDoctor() {
    inicioDoc ventanaDoctor = new inicioDoc();
    ...
    usuario.setPasss(pass);

    try {
         UsuariosInter usuarioDao = new UserImp();
        Usuarios usuarioValidado = usuarioDao.verificarUser(usuario);
        
        if (usuarioValidado != null) {
            String nivel = usuarioValidado.getRole();
            
           
                        try {
                javax.swing.UIManager.setLookAndFeel(new FlatMaterialLighterIJTheme());
